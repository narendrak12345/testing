...
import Pages_AHS_PHY.New_Physician;
...
public class New_Physician_Test extends BaseTest {
	public New_Physician NewPhy;
	public Login_Page login;
	public Readdata data;
	
	public New_Physician_Test() throws IOException {
		super();
	}
	...
	public void excutebefore() throws IOException {
		init();
		NewPhy = new New_Physician();
		login = new Login_Page();
		data = new Readdata();
	}
	
	@Test
	@Description("Invite a Physician to the Portal ")
	public void InvitePHY() throws InterruptedException, IOException, ParseException {
		...
		Assert.assertEquals(actual,"Invitation Sent Successfully.");
	}
	
	@Test
	@Description("Invite a existing Physician to the Portal")
	public void InviteExistingPHY() throws InterruptedException, IOException, ParseException {
		login.checklogin(prop.getProperty("phy_email"), prop.getProperty("password"), prop.getProperty("otp"));
		Thread.sleep(2000);
		String actual= NewPhy.InviteExistingAdmin(data.jsondata("Physician_email"));
		log.info("actual: "+actual);
